...
Session: Alpha 0.1.0-alpha.5 docs publish â€” example-heavy README / npm / crates / examples/

## Now

Alpha gate `0.1.0-alpha.5` is published. User-facing docs were rebuilt around
...
- GitHub Release: https://github.com/Weavatrix/weavatrix-quality/releases/tag/v0.1.0-alpha.5
- crates.io: full publishable closure at `0.1.0-alpha.5`
