...
Session: P1 — `wvq doctor` read-only discovery
...
P0 from the 2026-09-02 reaudit is implemented on this tree. `wvq doctor` is on `main`. Remaining P1 is self-dogfood, the 30–50 PR observe-only campaign, and Studio exception cards.
